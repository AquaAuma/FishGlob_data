...
author: "fishglob, Malin L. Pinsky, Aurore A. Maureaud, Juliano Palacios Abrantes, Zoë Kitchel, Dan Forrest, & Michelle Stuart"
...
library(here) # for navigating directories
...
This document presents the cleaning code and summary of the Gulf of Mexico (US) bottom trawl survey provided by [Jeff Rester](jrester@gsmfc.org), Coordinator - Gulf States Marine Fisheries Commission - Habitat Focus Team - Gulf of Mexico Program & [David Hanisko](david.s.hanisko@noaa.gov), Research Fisheries Biologist, National Marine Fisheries Service, Southeast Fisheries Science Center. It contains annual data from 1982 and up to 2024.


## Data cleaning in R

```{r cleaning_code, code = readLines(here("./cleaning_codes/get_gmex.R")), eval = FALSE}
...
load(here("outputs/Cleaned_data/GMEX_clean.RData"))
survey <- data
rm(data)
...
```{r, echo=FALSE, out.width = '80%'} 
knitr::include_graphics(here::here("outputs", "Flags", "trimming_method1", "hex_res7", "GMEX-Summer_hex_res_7_plot.png"))
```
```{r, echo=FALSE, out.width = '80%'}
knitr::include_graphics(here::here("outputs", "Flags", "trimming_method1", "hex_res8","GMEX-Summer_hex_res_8_plot.png"))
```

Map of hauls retained and removed per flagging method and threshold

```{r, echo=FALSE, out.width = '100%'}
knitr::include_graphics(here::here("outputs", "Flags", "trimming_method1", "hex_res7","GMEX-Summer_hex_res_7_map_per_haul.png"))
```

```{r, echo=FALSE, out.width = '100%'}
knitr::include_graphics(here::here("outputs", "Flags", "trimming_method1", "hex_res8","GMEX-Summer_hex_res_8_map_per_haul.png"))
```
...
```{r, echo=FALSE, out.width = '100%'}
knitr::include_graphics(here::here("outputs", "Flags", "trimming_method1", "hex_res7","GMEX-Summer_hex_res_7_map_per_grid_nyears.png"))
```


```{r, echo=FALSE, out.width = '100%'}
knitr::include_graphics(here::here("outputs", "Flags", "trimming_method1", "hex_res8","GMEX-Summer_hex_res_8_map_per_grid_nyears.png"))
```
...
```{r, echo=FALSE}
met1_7 <- read.csv(here::here("outputs", "Flags", "trimming_method1", "hex_res7", "GMEX-Summer_hex_res_7_stats_hauls.csv"))
met1_8 <- read.csv(here::here("outputs", "Flags", "trimming_method1", "hex_res8", "GMEX-Summer_hex_res_8_stats_hauls.csv"))
...
```{r, echo=FALSE, out.width = '80%'} 
knitr::include_graphics(here::here("outputs", "Flags", "trimming_method1", "hex_res7", "GMEX-Fall_hex_res_7_plot.png"))
```
```{r, echo=FALSE, out.width = '80%'}
knitr::include_graphics(here::here("outputs", "Flags", "trimming_method1", "hex_res8","GMEX-Fall_hex_res_8_plot.png"))
```

Map of hauls retained and removed per flagging method and threshold

```{r, echo=FALSE, out.width = '100%'}
knitr::include_graphics(here::here("outputs", "Flags", "trimming_method1", "hex_res7","GMEX-Fall_hex_res_7_map_per_haul.png"))
```

```{r, echo=FALSE, out.width = '100%'}
knitr::include_graphics(here::here("outputs", "Flags", "trimming_method1", "hex_res8","GMEX-Fall_hex_res_8_map_per_haul.png"))
```
...
```{r, echo=FALSE, out.width = '100%'}
knitr::include_graphics(here::here("outputs", "Flags", "trimming_method1", "hex_res7","GMEX-Fall_hex_res_7_map_per_grid_nyears.png"))
```


```{r, echo=FALSE, out.width = '100%'}
knitr::include_graphics(here::here("outputs", "Flags", "trimming_method1", "hex_res8","GMEX-Fall_hex_res_8_map_per_grid_nyears.png"))
```
...
```{r, echo=FALSE}
met1_7 <- read.csv(here::here("outputs", "Flags", "trimming_method1", "hex_res7", "GMEX-Fall_hex_res_7_stats_hauls.csv"))
met1_8 <- read.csv(here::here("outputs", "Flags", "trimming_method1", "hex_res8", "GMEX-Fall_hex_res_8_stats_hauls.csv"))
met2 <- read.csv(here::here("outputs", "Flags", "trimming_method2", 
