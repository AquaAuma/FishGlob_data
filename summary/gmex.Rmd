---
title: "GMEX: Gulf of Mexico US survey data processing summary"
...
This document presents the cleaning code and summary of the Gulf of Mexico (US) bottom trawl survey provided by [Jeff Rester](jrester@gsmfc.org), Coordinator - Gulf States Marine Fisheries Commission - Habitat Focus Team - Gulf of Mexico Program & [David Hanisko](david.s.hanisko@noaa.gov), Research Fisheries Biologist, National Marine Fisheries Service, Southeast Fisheries Science Center. It contains annual data from 1982 and up to 2019.


## Data cleaning in R

```{r cleaning_code, code = readLines(here("./cleaning.codes/get.gmex.R")), eval = FALSE}
...
survey <- read.csv(here("./summary/GMEX_clean.csv"))
...
```{r, echo=FALSE, out.width = '80%'} 
knitr::include_graphics(here::here("standardization_steps", "outputs", "trimming_method1", "hex_res7", "GMEX-Summer_hex_res_7_plot.png"))
```
```{r, echo=FALSE, out.width = '80%'}
knitr::include_graphics(here::here("standardization_steps", "outputs", "trimming_method1", "hex_res8","GMEX-Summer_hex_res_8_plot.png"))
```

Map of hauls retained and removed per flagging method and threshold

```{r, echo=FALSE, out.width = '100%'}
knitr::include_graphics(here::here("standardization_steps", "outputs", "trimming_method1", "hex_res7","GMEX-Summer_hex_res_7_map_per_haul.png"))
```

```{r, echo=FALSE, out.width = '100%'}
knitr::include_graphics(here::here("standardization_steps", "outputs", "trimming_method1", "hex_res8","GMEX-Summer_hex_res_8_map_per_haul.png"))
```
...
```{r, echo=FALSE, out.width = '100%'}
knitr::include_graphics(here::here("standardization_steps", "outputs", "trimming_method1", "hex_res7","GMEX-Summer_hex_res_7_map_per_grid_nyears.png"))
```


```{r, echo=FALSE, out.width = '100%'}
knitr::include_graphics(here::here("standardization_steps", "outputs", "trimming_method1", "hex_res8","GMEX-Summer_hex_res_8_map_per_grid_nyears.png"))
```
...
```{r, echo=FALSE}
met1_7 <- read.csv(here::here("standardization_steps", "outputs", "trimming_method1", "hex_res7", "GMEX-Summer_hex_res_7_stats_hauls.csv"))
met1_8 <- read.csv(here::here("standardization_steps", "outputs", "trimming_method1", "hex_res8", "GMEX-Summer_hex_res_8_stats_hauls.csv"))
met2 <- read.csv(here::here("standardization_steps", "outputs", "trimming_method2", 
                            "GMEX-Summer_stats_hauls.csv"))
...
```{r, echo=FALSE, out.width = '80%'} 
knitr::include_graphics(here::here("standardization_steps", "outputs", "trimming_method1", "hex_res7", "GMEX-Fall_hex_res_7_plot.png"))
```
```{r, echo=FALSE, out.width = '80%'}
knitr::include_graphics(here::here("standardization_steps", "outputs", "trimming_method1", "hex_res8","GMEX-Fall_hex_res_8_plot.png"))
```

Map of hauls retained and removed per flagging method and threshold

```{r, echo=FALSE, out.width = '100%'}
knitr::include_graphics(here::here("standardization_steps", "outputs", "trimming_method1", "hex_res7","GMEX-Fall_hex_res_7_map_per_haul.png"))
```

```{r, echo=FALSE, out.width = '100%'}
knitr::include_graphics(here::here("standardization_steps", "outputs", "trimming_method1", "hex_res8","GMEX-Fall_hex_res_8_map_per_haul.png"))
```
...
```{r, echo=FALSE, out.width = '100%'}
knitr::include_graphics(here::here("standardization_steps", "outputs", "trimming_method1", "hex_res7","GMEX-Fall_hex_res_7_map_per_grid_nyears.png"))
```


```{r, echo=FALSE, out.width = '100%'}
knitr::include_graphics(here::here("standardization_steps", "outputs", "trimming_method1", "hex_res8","GMEX-Fall_hex_res_8_map_per_grid_nyears.png"))
```
...
```{r, echo=FALSE}
met1_7 <- read.csv(here::here("standardization_steps", "outputs", "trimming_method1", "hex_res7", "GMEX-Fall_hex_res_7_stats_hauls.csv"))
met1_8 <- read.csv(here::here("standardization_steps", "outputs", "trimming_method1", "hex_res8", "GMEX-Fall_hex_res_8_stats_hauls.csv"))
met2 <- read.csv(here::here("standardization_steps", "outputs", "trimming_method2", 
                            "GMEX-Fall_stats_hauls.csv"))
knitr::kable(cbind(met1_7, met1_8[,2:3], met2[,2]), 
             col.names = c("summary", "grid cell 7, 0% threshold", "grid cell 7, 2% threshold", 
                           "grid cell 8, 0% threshold", "grid cell 8, 2% threshold",
                           "method 2 (biotime)")) %>% 
...
file.remove(here("./summary/GMEX_clean.csv")) # changed for multiple users
```
