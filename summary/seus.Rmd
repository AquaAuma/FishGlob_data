...
```{r cleaning_code, code = readLines(here("./cleaning.codes/get.seus.R")), eval = FALSE}
...
if(!is.na(mean(survey$num_cpue, na.rm=T)) & !is.na(mean(survey$wgt_cpue, na.rm=T))){
  ...
  summarize(Number_Taxa = length(accepted_name), Abundance = sum(num_cpue),Weight = sum(wgt_cpue)) %>% 
  gather("var","val",4:6) %>% 
  # head()
  ggplot() +
...
if(is.na(mean(survey$num_cpue, na.rm=T)) & !is.na(mean(survey$wgt_cpue, na.rm=T))){
  var_plot <-  survey %>%
  group_by(haul_id, haul_dur, area_swept) %>%
  summarize(Number_Taxa = length(accepted_name), Weight = sum(wgt_cpue)) %>% 
  gather("var","val",4:5) %>% 
  # head()
  ggplot() +
  geom_point(aes(x = area_swept, y = val),size=0.5)  +
...
if(!is.na(mean(survey$num_cpue, na.rm=T))){
spp <- survey %>% 
...
```{r, echo=FALSE, out.width = '80%'} 
knitr::include_graphics(here::here("standardization_steps", "outputs", "trimming_method1", "hex_res7", "SEUS-summer_hex_res_7_plot.png"))
```
```{r, echo=FALSE, out.width = '80%'}
knitr::include_graphics(here::here("standardization_steps", "outputs", "trimming_method1", "hex_res8","SEUS-summer_hex_res_8_plot.png"))
```

Map of hauls retained and removed per flagging method and threshold

```{r, echo=FALSE, out.width = '100%'}
knitr::include_graphics(here::here("standardization_steps", "outputs", "trimming_method1", "hex_res7","SEUS-summer_hex_res_7_map_per_haul.png"))
```

```{r, echo=FALSE, out.width = '100%'}
knitr::include_graphics(here::here("standardization_steps", "outputs", "trimming_method1", "hex_res8","SEUS-summer_hex_res_8_map_per_haul.png"))
```
...
```{r, echo=FALSE, out.width = '100%'}
knitr::include_graphics(here::here("standardization_steps", "outputs", "trimming_method1", "hex_res7","SEUS-summer_hex_res_7_map_per_grid_nyears.png"))
```


```{r, echo=FALSE, out.width = '100%'}
knitr::include_graphics(here::here("standardization_steps", "outputs", "trimming_method1", "hex_res8","SEUS-summer_hex_res_8_map_per_grid_nyears.png"))
```
...
```{r, echo=FALSE}
met1_7 <- read.csv(here::here("standardization_steps", "outputs", "trimming_method1", "hex_res7", "SEUS-summer_hex_res_7_stats_hauls.csv"))
met1_8 <- read.csv(here::here("standardization_steps", "outputs", "trimming_method1", "hex_res8", "SEUS-summer_hex_res_8_stats_hauls.csv"))
...
```{r, echo=FALSE, out.width = '80%'} 
knitr::include_graphics(here::here("standardization_steps", "outputs", "trimming_method1", "hex_res7", "SEUS-fall_hex_res_7_plot.png"))
```
```{r, echo=FALSE, out.width = '80%'}
knitr::include_graphics(here::here("standardization_steps", "outputs", "trimming_method1", "hex_res8","SEUS-fall_hex_res_8_plot.png"))
```

Map of hauls retained and removed per flagging method and threshold

```{r, echo=FALSE, out.width = '100%'}
knitr::include_graphics(here::here("standardization_steps", "outputs", "trimming_method1", "hex_res7","SEUS-fall_hex_res_7_map_per_haul.png"))
```

```{r, echo=FALSE, out.width = '100%'}
knitr::include_graphics(here::here("standardization_steps", "outputs", "trimming_method1", "hex_res8","SEUS-fall_hex_res_8_map_per_haul.png"))
```
...
```{r, echo=FALSE, out.width = '100%'}
knitr::include_graphics(here::here("standardization_steps", "outputs", "trimming_method1", "hex_res7","SEUS-fall_hex_res_7_map_per_grid_nyears.png"))
```


```{r, echo=FALSE, out.width = '100%'}
knitr::include_graphics(here::here("standardization_steps", "outputs", "trimming_method1", "hex_res8","SEUS-fall_hex_res_8_map_per_grid_nyears.png"))
```
...
```{r, echo=FALSE}
met1_7 <- read.csv(here::here("standardization_steps", "outputs", "trimming_method1", "hex_res7", "SEUS-fall_hex_res_7_stats_hauls.csv"))
met1_8 <- read.csv(here::here("standardization_steps", "outputs", "trimming_method1", "hex_res8", "SEUS-fall_hex_res_8_stats_hauls.csv"))
met2 <- read.csv(here::here("standardization_steps", "outputs", "trimming_method2", 
...
```{r, echo=FALSE, out.width = '80%'} 
knitr::include_graphics(here::here("standardization_steps", "outputs", "trimming_method1", "hex_res7", "SEUS-spring_hex_res_7_plot.png"))
```
```{r, echo=FALSE, out.width = '80%'}
knitr::include_graphics(here::here("standardization_steps", "outputs", "trimming_method1", "hex_res8","SEUS-spring_hex_res_8_plot.png"))
```

Map of hauls retained and removed per flagging method and threshold

```{r, echo=FALSE, out.width = '100%'}
knitr::include_graphics(here::here("standardization_steps", "outputs", "trimming_method1", "hex_res7","SEUS-spring_hex_res_7_map_per_haul.png"))
```

```{r, echo=FALSE, out.width = '100%'}
knitr::include_graphics(here::here("standardization_steps", "outputs", "trimming_method1", "hex_res8","SEUS-spring_hex_res_8_map_per_haul.png"))
```
...
```{r, echo=FALSE, out.width = '100%'}
knitr::include_graphics(here::here("standardization_steps", "outputs", "trimming_method1", "hex_res7","SEUS-spring_hex_res_7_map_per_grid_nyears.png"))
```


```{r, echo=FALSE, out.width = '100%'}
knitr::include_graphics(here::here("standardization_steps", "outputs", "trimming_method1", "hex_res8","SEUS-spring_hex_res_8_map_per_grid_nyears.png"))
```
...
```{r, echo=FALSE}
met1_7 <- read.csv(here::here("standardization_steps", "outputs", "trimming_method1", "hex_res7", "SEUS-spring_hex_res_7_stats_hauls.csv"))
met1_8 <- read.csv(here::here("standardization_steps", "outputs", "trimming_method1", "hex_res8", "SEUS-spring_hex_res_8_stats_hauls.csv"))
met2 <- read.csv(here::here("standardization_steps", "outputs", "trimming_method2", 
...
file.remove(here("./summary/SEUS_clean.csv")) # changed for multiple users
```
