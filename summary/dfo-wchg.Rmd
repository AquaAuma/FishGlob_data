---
title: "DFO-WCHG: Department of Fisheries Oceans Canada Haida Gwaii survey data processing summary"
...
This document presents the cleaning code and summary of the West Coast Haida Gwaii (Department of Fisheries Oceans Canada) bottom trawl survey provided by [Shelee Hamilton](Shelee.Hamilton@dfo-mpo.gc.ca), and [Maria Cornthwaite](Maria.Cornthwaite@dfo-mpo.gc.ca). It contains data from 2005 and up to 2019.


## Data cleaning in R

```{r cleaning_code, code = readLines(here("./cleaning.codes/get.dfo-wchg.R")), eval = FALSE}
...
survey <- read.csv(here("./summary/WCHG_clean.csv"))
...
file.remove(here("./summary/WCHG_clean.csv")) # changed for multiple users
```
