---
title: "ROCKALL: Rockall survey data processing summary"
...
This document presents the cleaning code and summary of the North Sea bottom trawl survey provided by DATRAS, ICES. It contains data from **1999** and up to **2020**.
...
file.remove(here("./summary/DATRAS_v3_clean.csv"))
```