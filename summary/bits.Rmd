---
title: "BITS: Baltic International Trawl Survey data processing summary"
...
This document presents the cleaning code and summary of the Baltic Sea bottom trawl survey provided by DATRAS, ICES. It contains data from **1992** and up to **2020**.
...
survey <- read.csv(here("/Users/auroremaureaud/Documents/FISHGLOB/data/Cleaned_data_DEC_2022_1/DATRAS_v3_clean.csv")) %>% 
  filter(survey == "BITS")
...
## 10. Spatio-temporal standardization: BITS-1
...
```{r, echo=FALSE, out.width = '80%'} 
knitr::include_graphics(here::here("standardization_steps", "outputs", "trimming_method1", "hex_res7", "BITS-1_hex_res_7_plot.png"))
```
```{r, echo=FALSE, out.width = '80%'}
knitr::include_graphics(here::here("standardization_steps", "outputs", "trimming_method1", "hex_res8","BITS-1_hex_res_8_plot.png"))
```

Map of hauls retained and removed per flagging method and threshold

```{r, echo=FALSE, out.width = '100%'}
knitr::include_graphics(here::here("standardization_steps", "outputs", "trimming_method1", "hex_res7","BITS-1_hex_res_7_map_per_haul.png"))
```

```{r, echo=FALSE, out.width = '100%'}
knitr::include_graphics(here::here("standardization_steps", "outputs", "trimming_method1", "hex_res8","BITS-1_hex_res_8_map_per_haul.png"))
```
...
```{r, echo=FALSE, out.width = '100%'}
knitr::include_graphics(here::here("standardization_steps", "outputs", "trimming_method1", "hex_res7","BITS-1_hex_res_7_map_per_grid_nyears.png"))
```


```{r, echo=FALSE, out.width = '100%'}
knitr::include_graphics(here::here("standardization_steps", "outputs", "trimming_method1", "hex_res8","BITS-1_hex_res_8_map_per_grid_nyears.png"))
```
...
```{r, echo=FALSE}
met1_7 <- read.csv(here::here("standardization_steps", "outputs", "trimming_method1", "hex_res7", "BITS-1_hex_res_7_stats_hauls.csv"))
met1_8 <- read.csv(here::here("standardization_steps", "outputs", "trimming_method1", "hex_res8", "BITS-1_hex_res_8_stats_hauls.csv"))
met2 <- read.csv(here::here("standardization_steps", "outputs", "trimming_method2", 
                            "BITS-1_stats_hauls.csv"))
...
\clearpage
## 11. Spatio-temporal standardization: BITS-4
...
```{r, echo=FALSE, out.width = '80%'} 
knitr::include_graphics(here::here("standardization_steps", "outputs", "trimming_method1", "hex_res7", "BITS-4_hex_res_7_plot.png"))
```
```{r, echo=FALSE, out.width = '80%'}
knitr::include_graphics(here::here("standardization_steps", "outputs", "trimming_method1", "hex_res8","BITS-4_hex_res_8_plot.png"))
```

Map of hauls retained and removed per flagging method and threshold

```{r, echo=FALSE, out.width = '100%'}
knitr::include_graphics(here::here("standardization_steps", "outputs", "trimming_method1", "hex_res7","BITS-4_hex_res_7_map_per_haul.png"))
```

```{r, echo=FALSE, out.width = '100%'}
knitr::include_graphics(here::here("standardization_steps", "outputs", "trimming_method1", "hex_res8","BITS-4_hex_res_8_map_per_haul.png"))
```
...
```{r, echo=FALSE, out.width = '100%'}
knitr::include_graphics(here::here("standardization_steps", "outputs", "trimming_method1", "hex_res7","BITS-4_hex_res_7_map_per_grid_nyears.png"))
```


```{r, echo=FALSE, out.width = '100%'}
knitr::include_graphics(here::here("standardization_steps", "outputs", "trimming_method1", "hex_res8","BITS-4_hex_res_8_map_per_grid_nyears.png"))
```
...
```{r, echo=FALSE}
met1_7 <- read.csv(here::here("standardization_steps", "outputs", "trimming_method1", "hex_res7", "BITS-4_hex_res_7_stats_hauls.csv"))
met1_8 <- read.csv(here::here("standardization_steps", "outputs", "trimming_method1", "hex_res8", "BITS-4_hex_res_8_stats_hauls.csv"))
met2 <- read.csv(here::here("standardization_steps", "outputs", "trimming_method2", 
                            "BITS-4_stats_hauls.csv"))
knitr::kable(cbind(met1_7, met1_8[,2:3], met2[,2]), 
             col.names = c("summary", "grid cell 7, 0% threshold", "grid cell 7, 2% threshold", 
                           "grid cell 8, 0% threshold", "grid cell 8, 2% threshold",
                           "method 2 (biotime)")) %>% 
