---
title: "SP-NORTH: North of Spain Bottom Trawl survey data processing summary"
...
This document presents the cleaning code and summary of the Northern Spanish bottom trawl survey provided by DATRAS, ICES. It contains data from **1990** and up to **2019**.
...
load(here("outputs/Cleaned_data/SP-NORTH_clean.RData"))
survey <- data
rm(data)
