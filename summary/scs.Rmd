---
title: "SCS: Canadian Maritimes survey data processing summary"
...
This document presents the cleaning code and summary of the Canadian Maritimes bottom trawl survey provided by [Mike McMahon](mike.mcmahon@dfo-mpo.gc.ca), [Don Clark](don.clark@dfo-mpo.gc.ca), and [Brian Bower](brian.bower@dfo-mpo.gc.ca). It contains data from 1970 and up to 2020.


## Data cleaning in R

```{r cleaning_code, code = readLines(here("./cleaning.codes/get.scs.R")), eval = FALSE}
...
survey <- read.csv(here("./summary/SCS_clean.csv"))
...
```{r, echo=FALSE, out.width = '80%'} 
knitr::include_graphics(here::here("standardization_steps", "outputs", "trimming_method1", "hex_res7", "SCS-SUMMER_hex_res_7_plot.png"))
```
```{r, echo=FALSE, out.width = '80%'}
knitr::include_graphics(here::here("standardization_steps", "outputs", "trimming_method1", "hex_res8","SCS-SUMMER_hex_res_8_plot.png"))
```

Map of hauls retained and removed per flagging method and threshold

```{r, echo=FALSE, out.width = '100%'}
knitr::include_graphics(here::here("standardization_steps", "outputs", "trimming_method1", "hex_res7","SCS-SUMMER_hex_res_7_map_per_haul.png"))
```

```{r, echo=FALSE, out.width = '100%'}
knitr::include_graphics(here::here("standardization_steps", "outputs", "trimming_method1", "hex_res8","SCS-SUMMER_hex_res_8_map_per_haul.png"))
```
...
```{r, echo=FALSE, out.width = '100%'}
knitr::include_graphics(here::here("standardization_steps", "outputs", "trimming_method1", "hex_res7","SCS-SUMMER_hex_res_7_map_per_grid_nyears.png"))
```


```{r, echo=FALSE, out.width = '100%'}
knitr::include_graphics(here::here("standardization_steps", "outputs", "trimming_method1", "hex_res8","SCS-SUMMER_hex_res_8_map_per_grid_nyears.png"))
```
...
```{r, echo=FALSE}
met1_7 <- read.csv(here::here("standardization_steps", "outputs", "trimming_method1", "hex_res7", "SCS-SUMMER_hex_res_7_stats_hauls.csv"))
met1_8 <- read.csv(here::here("standardization_steps", "outputs", "trimming_method1", "hex_res8", "SCS-SUMMER_hex_res_8_stats_hauls.csv"))
met2 <- read.csv(here::here("standardization_steps", "outputs", "trimming_method2", 
                            "SCS-SUMMER_stats_hauls.csv"))
...
```{r, echo=FALSE, out.width = '80%'} 
knitr::include_graphics(here::here("standardization_steps", "outputs", "trimming_method1", "hex_res7", "SCS-FALL_hex_res_7_plot.png"))
```
```{r, echo=FALSE, out.width = '80%'}
knitr::include_graphics(here::here("standardization_steps", "outputs", "trimming_method1", "hex_res8","SCS-FALL_hex_res_8_plot.png"))
```

Map of hauls retained and removed per flagging method and threshold

```{r, echo=FALSE, out.width = '100%'}
knitr::include_graphics(here::here("standardization_steps", "outputs", "trimming_method1", "hex_res7","SCS-FALL_hex_res_7_map_per_haul.png"))
```

```{r, echo=FALSE, out.width = '100%'}
knitr::include_graphics(here::here("standardization_steps", "outputs", "trimming_method1", "hex_res8","SCS-FALL_hex_res_8_map_per_haul.png"))
```
...
```{r, echo=FALSE, out.width = '100%'}
knitr::include_graphics(here::here("standardization_steps", "outputs", "trimming_method1", "hex_res7","SCS-FALL_hex_res_7_map_per_grid_nyears.png"))
```


```{r, echo=FALSE, out.width = '100%'}
knitr::include_graphics(here::here("standardization_steps", "outputs", "trimming_method1", "hex_res8","SCS-FALL_hex_res_8_map_per_grid_nyears.png"))
```
...
```{r, echo=FALSE}
met1_7 <- read.csv(here::here("standardization_steps", "outputs", "trimming_method1", "hex_res7", "SCS-FALL_hex_res_7_stats_hauls.csv"))
met1_8 <- read.csv(here::here("standardization_steps", "outputs", "trimming_method1", "hex_res8", "SCS-FALL_hex_res_8_stats_hauls.csv"))
# met2 <- read.csv(here::here("standardization_steps", "outputs", "trimming_method2", 
#                             "SCS-FALL_stats_hauls.csv"))
knitr::kable(cbind(met1_7, met1_8[,2:3]), 
             col.names = c("summary", "grid cell 7, 0% threshold", "grid cell 7, 2% threshold", 
                           "grid cell 8, 0% threshold", "grid cell 8, 2% threshold")) %>% 
  kable_styling(latex_options = "scale_down",
                position = "float_left")
...
```{r, echo=FALSE, out.width = '80%'} 
knitr::include_graphics(here::here("standardization_steps", "outputs", "trimming_method1", "hex_res7", "SCS-SPRING_hex_res_7_plot.png"))
```
```{r, echo=FALSE, out.width = '80%'}
knitr::include_graphics(here::here("standardization_steps", "outputs", "trimming_method1", "hex_res8","SCS-SPRING_hex_res_8_plot.png"))
```

Map of hauls retained and removed per flagging method and threshold

```{r, echo=FALSE, out.width = '100%'}
knitr::include_graphics(here::here("standardization_steps", "outputs", "trimming_method1", "hex_res7","SCS-SPRING_hex_res_7_map_per_haul.png"))
```

```{r, echo=FALSE, out.width = '100%'}
knitr::include_graphics(here::here("standardization_steps", "outputs", "trimming_method1", "hex_res8","SCS-SPRING_hex_res_8_map_per_haul.png"))
```
...
```{r, echo=FALSE, out.width = '100%'}
knitr::include_graphics(here::here("standardization_steps", "outputs", "trimming_method1", "hex_res7","SCS-SPRING_hex_res_7_map_per_grid_nyears.png"))
```


```{r, echo=FALSE, out.width = '100%'}
knitr::include_graphics(here::here("standardization_steps", "outputs", "trimming_method1", "hex_res8","SCS-SPRING_hex_res_8_map_per_grid_nyears.png"))
```
...
```{r, echo=FALSE}
met1_7 <- read.csv(here::here("standardization_steps", "outputs", "trimming_method1", "hex_res7", "SCS-SPRING_hex_res_7_stats_hauls.csv"))
met1_8 <- read.csv(here::here("standardization_steps", "outputs", "trimming_method1", "hex_res8", "SCS-SPRING_hex_res_8_stats_hauls.csv"))
met2 <- read.csv(here::here("standardization_steps", "outputs", "trimming_method2", 
                            "SCS-SPRING_stats_hauls.csv"))
knitr::kable(cbind(met1_7, met1_8[,2:3], met2[,2]), 
             col.names = c("summary", "grid cell 7, 0% threshold", "grid cell 7, 2% threshold", 
                           "grid cell 8, 0% threshold", "grid cell 8, 2% threshold",
                           "method 2 (biotime)")) %>% 
...
file.remove(here("./summary/SCS_clean.csv")) # changed for multiple users
```
