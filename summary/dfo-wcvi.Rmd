---
title: "DFO-WCVI: Department of Fisheries Oceans Canada West Coast Vancouver Island survey data processing summary"
...
This document presents the cleaning code and summary of the West Coast Vancouver Island (Department of Fisheries Oceans Canada) bottom trawl survey provided by [Shelee Hamilton](Shelee.Hamilton@dfo-mpo.gc.ca), and [Maria Cornthwaite](Maria.Cornthwaite@dfo-mpo.gc.ca). It contains data from 2004 and up to 2018.


## Data cleaning in R

```{r cleaning_code, code = readLines(here("./cleaning.codes/get.dfo-wcvi.R")), eval = FALSE}
...
survey <- read.csv(here("./summary/WCVI_clean.csv"))
...
if(!is.na(mean(survey$num, na.rm=T)) & mean(survey$wgt, na.rm=T)){
  var_plot <-  survey %>%
  group_by(haul_id, haul_dur, area_swept) %>%
...
file.remove(here("./summary/WCVI_clean.csv")) # changed for multiple users
```
