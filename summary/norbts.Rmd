---
title: "NOR-BTS: Norwegian bottom trawl survey data processing summary"
author: "fishglob, Aurore A. Maureaud & Juliano Palacios Abrantes"
...
This document presents the cleaning code and summary of the Norwegian bottom trawl survey made available by IMR. It contains data from **1980** and up to **2017**.


## Data cleaning in R
```{r cleaning_code, code = readLines(here("./cleaning.codes/get.norway.R")), eval = FALSE}
...
### Survey data
x <- drive_find(pattern = "NOR-BTS_v3_clean.csv")

drive_download(file = x[1,],
  overwrite = TRUE)

survey <- read.csv(here("./summary/NOR-BTS_v3_clean.csv"))
...
```{r end, echo=FALSE, results='hide', include=FALSE}
file.remove(here("./summary/NOR-BTS_v3_clean.csv"))
```