...
This document presents the cleaning code and summary of the Norwegian Barents Sea bottom trawl survey made available by IMR. It contains data from **2004** and up to **2019**.


## Data cleaning in R
```{r cleaning_code, code = readLines(here("./cleaning_codes/get_norway.R")), eval = FALSE}
...
load(here("outputs/Cleaned_data/NOR-BTS_clean.RData"))
survey <- data
rm(data)
