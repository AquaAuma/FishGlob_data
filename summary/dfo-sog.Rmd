---
title: "DFO-HS: Department of Fisheries and Oceans Canada Strait of Georgia survey data processing summary"
...
This document presents the cleaning code and summary of the Strait of Georgia Survey (Department of Fisheries Oceans Canada) bottom trawl survey provided by [Maria Cornthwaite](Maria.Cornthwaite@dfo-mpo.gc.ca). It contains data from 2012 and up to 2015.


## Data cleaning in R

```{r cleaning_code, code = readLines(here("./cleaning_codes/get_dfo-sog.R")), eval = FALSE}
...
#   overwrite = TRUE)
# 
# survey <- read.csv(here("./summary/HS_clean.csv"))

load(here("outputs/Cleaned_data/SOG_clean.RData"))
survey <- data
rm(data)
...
This standardization method was adapted from BioTIME code from https://github.com/Wubing-Xu/Range_size_winners_losers. This method could not be applied to this survey because it contains too few years.
