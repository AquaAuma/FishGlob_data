---
title: "GSL-S: Gulf of St. Lawrence South (Canada) survey data processing summary"
...
This document presents the cleaning code and summary of the Gulf of St. Lawrence South (Canada) bottom trawl survey provided by [Department of Fisheries and Oceans Canada](gddaiss-dmsaisb.XLAU@dfo-mpo.gc.ca). It contains data from 1970 and up to 2019.


## Data cleaning in R

```{r cleaning_code, code = readLines(here("./cleaning.codes/get.gsl-s.R")), eval = FALSE}
...
### Survey data
# drive_download(file = "GSL-S_v2_clean.csv",
#   overwrite = TRUE)
# 
# survey <- read.csv(here("./summary/GSL-S_v2_clean.csv"))

load(here("outputs/Cleaned_data/GSL-S_v2_clean.RData"))
survey <- data
rm(data)
...
file.remove(here("./summary/GSL-S_v2_clean.csv")) # changed for multiple users
```
