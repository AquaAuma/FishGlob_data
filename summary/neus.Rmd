...
load(here("outputs/Cleaned_data/NEUS_clean.RData"))
survey <- data 
rm(data)
...
```{r, echo=FALSE, out.width = '80%'} 
knitr::include_graphics(here::here("outputs", "Flags", "trimming_method1", "hex_res7", "NEUS-Fall_hex_res_7_plot.png"))
```
```{r, echo=FALSE, out.width = '80%'}
knitr::include_graphics(here::here("outputs", "Flags", "trimming_method1", "hex_res8","NEUS-Fall_hex_res_8_plot.png"))
```

Map of hauls retained and removed per flagging method and threshold

```{r, echo=FALSE, out.width = '100%'}
knitr::include_graphics(here::here("outputs", "Flags", "trimming_method1", "hex_res7","NEUS-Fall_hex_res_7_map_per_haul.png"))
```

```{r, echo=FALSE, out.width = '100%'}
knitr::include_graphics(here::here("outputs", "Flags", "trimming_method1", "hex_res8","NEUS-Fall_hex_res_8_map_per_haul.png"))
```
...
```{r, echo=FALSE, out.width = '100%'}
knitr::include_graphics(here::here("outputs", "Flags", "trimming_method1", "hex_res7","NEUS-Fall_hex_res_7_map_per_grid_nyears.png"))
```


```{r, echo=FALSE, out.width = '100%'}
knitr::include_graphics(here::here("outputs", "Flags", "trimming_method1", "hex_res8","NEUS-Fall_hex_res_8_map_per_grid_nyears.png"))
```
...
```{r, echo=FALSE}
met1_7 <- read.csv(here::here("outputs", "Flags", "trimming_method1", "hex_res7", "NEUS-Fall_hex_res_7_stats_hauls.csv"))
met1_8 <- read.csv(here::here("outputs", "Flags", "trimming_method1", "hex_res8", "NEUS-Fall_hex_res_8_stats_hauls.csv"))
...
```{r, echo=FALSE, out.width = '80%'} 
knitr::include_graphics(here::here("outputs", "Flags", "trimming_method1", "hex_res7", "NEUS-Spring_hex_res_7_plot.png"))
```
```{r, echo=FALSE, out.width = '80%'}
knitr::include_graphics(here::here("outputs", "Flags", "trimming_method1", "hex_res8","NEUS-Spring_hex_res_8_plot.png"))
```

Map of hauls retained and removed per flagging method and threshold

```{r, echo=FALSE, out.width = '100%'}
knitr::include_graphics(here::here("outputs", "Flags", "trimming_method1", "hex_res7","NEUS-Spring_hex_res_7_map_per_haul.png"))
```

```{r, echo=FALSE, out.width = '100%'}
knitr::include_graphics(here::here("outputs", "Flags", "trimming_method1", "hex_res8","NEUS-Spring_hex_res_8_map_per_haul.png"))
```
...
```{r, echo=FALSE, out.width = '100%'}
knitr::include_graphics(here::here("outputs", "Flags", "trimming_method1", "hex_res7","NEUS-Spring_hex_res_7_map_per_grid_nyears.png"))
```


```{r, echo=FALSE, out.width = '100%'}
knitr::include_graphics(here::here("outputs", "Flags", "trimming_method1", "hex_res8","NEUS-Spring_hex_res_8_map_per_grid_nyears.png"))
```
...
```{r, echo=FALSE}
met1_7 <- read.csv(here::here("outputs", "Flags", "trimming_method1", "hex_res7", "NEUS-Spring_hex_res_7_stats_hauls.csv"))
met1_8 <- read.csv(here::here("outputs", "Flags", "trimming_method1", "hex_res8", "NEUS-Spring_hex_res_8_stats_hauls.csv"))
met2 <- read.csv(here::here("outputs", "Flags", "trimming_method2", 
