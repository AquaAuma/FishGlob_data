---
title: "SP-PORC: Porcupine Bank Bottom Trawl survey data processing summary"
...
This document presents the cleaning code and summary of the Porcupine Bank bottom trawl survey provided by DATRAS, ICES. It contains data from **2001** and up to **2019**.
...
load(here("outputs/Cleaned_data/SP-PORC_clean.RData"))
survey <- data
rm(data)
...
No flagged taxa for this survey region
