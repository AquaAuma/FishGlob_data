---
title: "GOA: Gulf of Alaska survey data processing summary"
...
This document presents the summary of the Gulf of Alaska bottom trawl survey provided by [Stan Kotwicki](stan.kotwicki@noaa.gov) and [Jim Thorson](james.thorson@noaa.gov) It contains data from 1984-1999 (triennial) and 2001-2019 (biennial).


## Data cleaning in R

```{r cleaning_code, code = readLines(here::here("./cleaning.codes/get.goa.R")), eval = FALSE}
...
survey <- read.csv(here("./summary/GOA_clean.csv"))
...
file.remove(here("./summary/GOA_clean.csv")) # changed for multiple users
```
