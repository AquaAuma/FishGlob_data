---
title: "NS-IBTS: North Sea Bottom Trawl survey data processing summary"
...
This document presents the cleaning code and summary of the North Sea bottom trawl survey provided by DATRAS, ICES. It contains data from **1967** and up to **2020**.
...
```{r, echo=FALSE, out.width = '80%'} 
knitr::include_graphics(here::here("standardization_steps", "outputs", "trimming_method1", "hex_res7", "NS-IBTS-1_hex_res_7_plot.png"))
```
```{r, echo=FALSE, out.width = '80%'}
knitr::include_graphics(here::here("standardization_steps", "outputs", "trimming_method1", "hex_res8","NS-IBTS-1_hex_res_8_plot.png"))
```

Map of hauls retained and removed per flagging method and threshold

```{r, echo=FALSE, out.width = '100%'}
knitr::include_graphics(here::here("standardization_steps", "outputs", "trimming_method1", "hex_res7","NS-IBTS-1_hex_res_7_map_per_haul.png"))
```

```{r, echo=FALSE, out.width = '100%'}
knitr::include_graphics(here::here("standardization_steps", "outputs", "trimming_method1", "hex_res8","NS-IBTS-1_hex_res_8_map_per_haul.png"))
```
...
```{r, echo=FALSE, out.width = '100%'}
knitr::include_graphics(here::here("standardization_steps", "outputs", "trimming_method1", "hex_res7","NS-IBTS-1_hex_res_7_map_per_grid_nyears.png"))
```


```{r, echo=FALSE, out.width = '100%'}
knitr::include_graphics(here::here("standardization_steps", "outputs", "trimming_method1", "hex_res8","NS-IBTS-1_hex_res_8_map_per_grid_nyears.png"))
```
...
```{r, echo=FALSE}
met1_7 <- read.csv(here::here("standardization_steps", "outputs", "trimming_method1", "hex_res7", "NS-IBTS-1_hex_res_7_stats_hauls.csv"))
met1_8 <- read.csv(here::here("standardization_steps", "outputs", "trimming_method1", "hex_res8", "NS-IBTS-1_hex_res_8_stats_hauls.csv"))
met2 <- read.csv(here::here("standardization_steps", "outputs", "trimming_method2", 
                            "NS-IBTS-1_stats_hauls.csv"))
...
```{r, echo=FALSE, out.width = '80%'} 
knitr::include_graphics(here::here("standardization_steps", "outputs", "trimming_method1", "hex_res7", "NS-IBTS-3_hex_res_7_plot.png"))
```
```{r, echo=FALSE, out.width = '80%'}
knitr::include_graphics(here::here("standardization_steps", "outputs", "trimming_method1", "hex_res8","NS-IBTS-3_hex_res_8_plot.png"))
```

Map of hauls retained and removed per flagging method and threshold

```{r, echo=FALSE, out.width = '100%'}
knitr::include_graphics(here::here("standardization_steps", "outputs", "trimming_method1", "hex_res7","NS-IBTS-3_hex_res_7_map_per_haul.png"))
```

```{r, echo=FALSE, out.width = '100%'}
knitr::include_graphics(here::here("standardization_steps", "outputs", "trimming_method1", "hex_res8","NS-IBTS-3_hex_res_8_map_per_haul.png"))
```
...
```{r, echo=FALSE, out.width = '100%'}
knitr::include_graphics(here::here("standardization_steps", "outputs", "trimming_method1", "hex_res7","NS-IBTS-3_hex_res_7_map_per_grid_nyears.png"))
```


```{r, echo=FALSE, out.width = '100%'}
knitr::include_graphics(here::here("standardization_steps", "outputs", "trimming_method1", "hex_res8","NS-IBTS-3_hex_res_8_map_per_grid_nyears.png"))
```
...
```{r, echo=FALSE}
met1_7 <- read.csv(here::here("standardization_steps", "outputs", "trimming_method1", "hex_res7", "NS-IBTS-3_hex_res_7_stats_hauls.csv"))
met1_8 <- read.csv(here::here("standardization_steps", "outputs", "trimming_method1", "hex_res8", "NS-IBTS-3_hex_res_8_stats_hauls.csv"))
met2 <- read.csv(here::here("standardization_steps", "outputs", "trimming_method2", 
                            "NS-IBTS-3_stats_hauls.csv"))
knitr::kable(cbind(met1_7, met1_8[,2:3], met2[,2]), 
             col.names = c("summary", "grid cell 7, 0% threshold", "grid cell 7, 2% threshold", 
                           "grid cell 8, 0% threshold", "grid cell 8, 2% threshold",
                           "method 2 (biotime)")) %>% 
