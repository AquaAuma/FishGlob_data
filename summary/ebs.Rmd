---
title: "EBS: Eastern Bering Sea US survey data processing summary"
...
This document presents the summary of the Eastern Bering Sea bottom trawl survey provided by [Stan Kotwicki](stan.kotwicki@noaa.gov) and [Jim Thorson](james.thorson@noaa.gov) It contains annual data from 1982-2019.


## Data cleaning in R

```{r cleaning_code, code = readLines(here("./cleaning.codes/get.ebs.R")), eval = FALSE}
...
drive_download(file = "EBS_v2_clean.csv",
  overwrite = TRUE)

# survey <- read.csv(here("./summary/EBS_v2.csv"))
...
file.remove(here("./summary/EBS_v2_clean.csv")) # changed for multiple users
```
