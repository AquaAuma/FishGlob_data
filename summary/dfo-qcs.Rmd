---
title: "DFO-QCS: Department of Fisheries Oceans Canada Queen Charlotte Sound survey data processing summary"
...
This document presents the cleaning code and summary of the Queen Charlotte Sound (Department of Fisheries Oceans Canada) bottom trawl survey provided by [Shelee Hamilton](Shelee.Hamilton@dfo-mpo.gc.ca), and [Maria Cornthwaite](Maria.Cornthwaite@dfo-mpo.gc.ca). It contains data from 2003 and up to 2019.


## Data cleaning in R

```{r cleaning_code, code = readLines(here("./cleaning.codes/get.dfo-qcs.R")), eval = FALSE}
...
survey <- read.csv(here("./summary/QCS_clean.csv"))
...
file.remove(here("./summary/QCS_clean.csv")) # changed for multiple users
```
