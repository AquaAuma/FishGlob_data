---
title: "DFO-HS: Department of Fisheries and Oceans Canada Hecate Strait survey data processing summary"
...
This document presents the cleaning code and summary of the Hecate Strait Survey (Department of Fisheries Oceans Canada) bottom trawl survey provided by [Shelee Hamilton](Shelee.Hamilton@dfo-mpo.gc.ca), and [Maria Cornthwaite](Maria.Cornthwaite@dfo-mpo.gc.ca). It contains data from 2005 and up to 2019.


## Data cleaning in R

```{r cleaning_code, code = readLines(here("./cleaning.codes/get.dfo-hs.R")), eval = FALSE}
...
file.remove(here("./summary/HS_clean.csv")) # changed for multiple users
```
